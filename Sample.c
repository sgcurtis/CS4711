...
//#include </home/campus04/kycsmith/Desktop/Cunit-2.1-2/CUnit/Headers/CUnit.h>
//#include </home/campus04/kycsmith/Desktop/CUnit-2.1-2/CUnit/Headers/CUnit.h> 
//change this filepath to the filepath on YOUR MACHINE where you store CUnit-2.1-2
...
void cycleWork(){
  ...
  while(exit == 0)
      ...
      if(strcmp(yStartBuff,"exit") == 0)
	{
      ...
      //field[yStart][xStart] = '+';
      CU_ASSERT_STRING_EQUAL(field[xStart][yStart], '-');
    }
  struct Node* temp = head;
